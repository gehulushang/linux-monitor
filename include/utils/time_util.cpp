...
int main() {
    ...
    std::cout << util.GetTimestamp() << std::endl;
    

    std::cout << util.GetDatetime() << std::endl;
    std::cout << util.GetYear() << std::endl;
    std::cout << util.GetMonth() << std::endl;

    std::cout << util.GetWDay() << std::endl;
    std::cout << util.GetYDay() << std::endl;
